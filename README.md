...
> **An Open-Source Citizen Science Lab, 3D 6th-Grade Learning Hub, Zooniverse Specification, and Real-Time Clinical Triage Engine for Nantucket Island (*ACK*).**
...
[![Vitest](https://img.shields.io/badge/Vitest-34%20Passed-brightgreen.svg)](https://vitest.dev/)
[![FHIR R4 Standard](https://img.shields.io/badge/HL7-FHIR%20R4%20Bundle-firebrick.svg)](https://hl7.org/fhir/R4/)
[![GCP Cloud Run](https://img.shields.io/badge/GCP-Cloud%20Run%20(Scale--to--Zero)-blue.svg)](https://cloud.google.com/run)
...
<div align="center">
  <sub>Built with clinical precision and ecological stewardship by <b>Phillip Gear</b> & the <b>PocketGull Open Source Initiative</b>.</sub>
</div>
