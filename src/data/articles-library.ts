...
* Disposal: Bag root systems or burn in accordance with Town of Nantucket open-burn regulations. Never compost root fragments.`
  },
  {
    ...
    icon: '🛡️',
    imageUrl: '/images/permethrin_gear.jpg',
    imageCaption: 'Permethrin-treated socks and gaiters stop 99% of blacklegged nymphs before they can climb above the knee.',
    imageCredit: 'Wikimedia Commons / CDC Public Health Image Library',
